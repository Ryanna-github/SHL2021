...
from utils.self.dataLoader import SHLself.dataLoader
import utils.helper as helper

class self.dataProcesser():
    def __init__(self, self.dataloader):
        super(self.dataProcesser).__init__()
        self.self.data = self.dataloader
        if not isinstance(self.dataloader, SHLself.dataLoader):
